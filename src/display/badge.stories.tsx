...
export const AllVariants: Story = {
    render: () => (
        <div className="flex flex-wrap gap-2">
            <Badge className="rounded-full bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-700">Primary</Badge>
            <Badge className="rounded-full bg-secondary-100 px-2.5 py-0.5 text-xs font-medium text-secondary-700">Secondary</Badge>
            <Badge className="rounded-full bg-tertiary-100 px-2.5 py-0.5 text-xs font-medium text-tertiary-700">Tertiary</Badge>
...
export const Solid: Story = {
    render: () => (
        <div className="flex flex-wrap gap-2">
            <Badge className="rounded-full bg-primary-600 px-2.5 py-0.5 text-xs font-medium text-white">Primary</Badge>
            <Badge className="rounded-full bg-secondary-600 px-2.5 py-0.5 text-xs font-medium text-white">Secondary</Badge>
